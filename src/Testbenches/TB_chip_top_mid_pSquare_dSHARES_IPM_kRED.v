...
wire clk_PAD, rst_PAD, read_PAD, write_PAD, trigger_PAD, trigger;
...
// Unit Under Test
chip_top UUT (.clk_PAD(clk_PAD), .rst_PAD(rst_PAD), .read_PAD(read_PAD), .write_PAD(write_PAD), .address_PAD(address_PAD), .data_in_PAD(data_in_PAD), .data_out_PAD(data_out), .trigger_PAD(trigger));
